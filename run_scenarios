'''
Running from 2025 to 2060, varying screening probabilities, keep vax and ltfu the same at 90% levels
...
def run_scens(location=None, screen_scens=None, # Input data
    ...
    for msim in all_msims:
        ...
        df['new_screened'] = msim.results['new_screened'][:]
        df['new_screens'] = msim.results['new_screens'][:]
        #df['n_new_vaccinated'] = msim.results['n_new_vaccinated'][:]
        #df['cum_vaccinated'] = msim.results['cum_vaccinated'][:]
        df['cum_total_vaccinated'] = msim.results['cum_total_vaccinated'][:]
        df['new_doses'] = msim.results['new_doses'][:]
        df['new_total_vaccinated'] = msim.results['new_total_vaccinated'][:]
        df['new_cin_treated'] = msim.results['new_cin_treated'][:]
        df['new_cancer_treatments'] = msim.results['new_cancer_treatments'][:]
        df['new_cin_treatments'] = msim.results['new_cin_treatments'][:]
        df['cum_cin_treated'] = msim.results['cum_cin_treated'][:]
