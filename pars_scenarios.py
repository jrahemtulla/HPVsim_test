...
#change to 2040
def get_screen_intvs(location, primary=None, triage=None, ltfu=None, start_year=2025, end_year=2060, sim_end_year=2060, screen_coverage = 0.7,treat_prob = 0.9):
    ...
    #latest changes to screen probability - excluding ramp up functionality 
    age_range = [30, 50]
